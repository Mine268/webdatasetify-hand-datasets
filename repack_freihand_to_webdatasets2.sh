...
DEST_ROOT="${DEST_ROOT:-/mnt/qnap/data/datasets/webdatasets2/FreiHAND}"
...
repack_split train "freihand_train_wds_output/freihand_train-worker*.tar"
repack_split evaluation "freihand_evaluation_wds_output/freihand_evaluation-worker*.tar"
